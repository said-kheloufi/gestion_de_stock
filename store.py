...
class boutons_modif():
    ...
    def validationAdd(self):
        ...
        check2 = self.name_entry.get()
        check3 = self.description_entry.get()
        check4 = self.price_entry.get()
        check5 = self.quantity_entry.get()
        check6 = self.id_categoriy_entry.get()
    ...
    def validationModify(self):
        ...
        check2_2 = self.name_entry2.get()
        check2_3 = self.description_entry2.get()
        check2_4 = self.price_entry2.get()
        check2_5 = self.quantity_entry2.get()
        check2_6 = self.id_categoriy_entry2.get()
...
tree.heading(6, text= "NOM_CATEGORIE")
...
affich = 'SELECT product.id, product.name, product.description, product.price, product.quantity, category.name FROM product INNER JOIN category ON product.id_category = category.id'
cursor.execute(affich)
